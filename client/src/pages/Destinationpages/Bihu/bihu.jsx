...
export default function OnamBihuFestival() {
  ...
  const basePrices = { "3-star": 12000, "4-star": 18000, "5-star": 26000 };
  const [baseBudget, setBaseBudget] = useState(basePrices[hotelType]);

  const hotelNames = {
    "3-star": "Lotus Heritage Inn, Kochi",
    "4-star": "Green Harmony Resort, Alleppey",
    "5-star": "Royal Coconut Bay Resort, Kochi",
  };

  // 🔥 ONAM & BIHU (3-day) Itinerary
  const [itinerary, setItinerary] = useState([
    {
      day: "Day 1",
      cost: 3500,
      points: [
        "Arrival in Kochi & hotel check-in.",
        "Visit Onam Pookalam flower decoration displays.",
        "Evening: Explore marine drive & Kerala cultural programs.",
      ],
    },
    {
      day: "Day 2",
      cost: 6500,
      points: [
        "Traditional Onam Celebrations – Pookalam, Pulikali Tiger Dance.",
        "Experience Onam Sadya — grand traditional feast served on banana leaf.",
        "Attend a Bihu traditional dance performance in cultural pavilion.",
      ],
    },
    {
      day: "Day 3",
      cost: 4500,
      points: [
        "Alleppey backwaters boat experience.",
        "Visit Kerala arts & crafts village + Assamese handicraft stalls.",
        "Farewell cultural program with Kerala & Assam fusion performances.",
      ],
    },
  ]);

  const highlights = [
    "Witness colourful Pookalam (flower rangoli) displays",
    "Taste the traditional Onam Sadya feast",
    "Experience Pulikali (Tiger Dance) & Thiruvathira performances",
    "Special Bihu Dance cultural program from Assam",
    "Backwater boat ride in Alleppey",
  ];

  const included = [
    "Accommodation in selected hotel (2 nights)",
    "Daily breakfast & one Onam Sadya feast",
    "Local transport for all cultural activities",
    "Onam cultural village entry pass",
    "Backwater cruise ride",
  ];

  const notIncluded = [
    "Personal shopping expenses",
    "Lunch & dinner except one included meal",
    "Boat race VIP passes",
  ...
  const getTotalCost = () => {
    ...
    const festivalFeePerPerson = 800; // Onam+Bihu surcharge
  ...
  const handleDownload = async () => {
    ...
    addTitle("Onam & Bihu Festival Tour");
    addText("📍 Kochi, Kerala");
    addText("📅 August–September (3 days)");
    addText("⭐ 4.8");
    ...
    addText("Duration: 3 days (Onam + Bihu Festival)");
    ...
    pdf.save("Onam-Bihu-Itinerary.pdf");
  };
    ...
    <div className="bg-gray-50 min-h-screen">
      <div ref={contentRef}>
        ...
        <div
          ...
          style={{ backgroundImage: `url(${Onam1})` }}
        >
          ...
          <div className="relative max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-3">
              {["Onam", "Bihu", "Kerala", "Festival", "Culture"].map((tag) => (
                <span
                  key={tag}
            ...
            <div className="flex flex-wrap items-center gap-4 mt-3 text-sm">
              ...
              <p className="flex items-center gap-1">
                <CalendarDays size={16} /> August–September
              </p>
              <p>⏱️ 3 days</p>
              <p className="flex items-center gap-1">
                <Star size={16} className="text-yellow-300" /> 4.8
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow">
              ...
              <p className="text-gray-700">
                Celebrate the vibrant colours of Onam from Kerala along with the
                energetic dance traditions of Assam's Bihu. Witness cultural
                performances, enjoy festive feasts, explore backwaters, and
                experience a fusion of two iconic Indian festivals in one
                memorable trip.
              </p>
            </div>
