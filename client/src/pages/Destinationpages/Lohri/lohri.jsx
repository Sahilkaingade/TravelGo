// Full updated code with Lohri Festival information
...
export default function Lohri() {
  ...
  const basePrices = { "3-star": 26000, "4-star": 36000, "5-star": 52000 };
  const [baseBudget, setBaseBudget] = useState(basePrices[hotelType]);

  const hotelNames = {
    "3-star": "Hotel Amritsar Grand",
    "4-star": "Ramada by Wyndham, Amritsar",
    "5-star": "Hyatt Regency Amritsar",
  };

  // Lohri festival itinerary
  const [itinerary, setItinerary] = useState([
    {
      day: "Day 1–2",
      cost: 8000,
      points: [
        "Arrival in Punjab & welcome with traditional sweets.",
        "Visit local village and experience Punjabi culture.",
        "Explore Lohri bazaar & cultural markets.",
      ],
    },
    {
      day: "Day 3–5",
      cost: 16000,
      points: [
        "Attend Lohri ceremony with bonfire celebrations.",
        "Enjoy Gidda & Bhangra performances.",
        "Traditional Punjabi dinner with live folk music.",
      ],
    },
    {
      day: "Day 6–7",
      ...
      points: [
        ...
        "Explore Amritsar local food & heritage walk.",
  ...
  const highlights = [
    ...
    "Traditional Bhangra & Gidda performances",
    "Authentic Punjabi food & sweets",
    "Visit Golden Temple & Wagah Border",
  ];
  ...
  const included = [
    ...
    "Entry to Lohri festival events",
    "Private AC vehicle for sightseeing",
    "Golden Temple & cultural village tour",
  ];

  const notIncluded = [
    "Personal shopping expenses",
    "Lunch during travel days",
    "VIP Lohri stage passes",
    "Travel insurance",
  ];
  ...
  const handleDownload = async () => {
    ...
    addTitle("Lohri Festival Tour");
    addText("📍 Punjab, India");
    addText("📅 January 11 – January 18, 2025 (7 days)");
    addText("⭐ 4.8");
    ...
    pdf.save("Lohri-Festival-Itinerary.pdf");
  };
        ...
        >
          ...
          <div className="relative max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-3">
              {["Lohri", "Punjab", "Festival", "Culture", "Bonfire"].map(tag => (
            ...
            <h1 className="text-4xl font-bold drop-shadow-md">Lohri Festival Tour</h1>

            <div className="flex flex-wrap items-center gap-4 mt-3 text-sm">
              <p className="flex items-center gap-1"><MapPin size={16} /> Punjab, India</p>
              <p className="flex items-center gap-1"><CalendarDays size={16} /> January 11 – 18</p>
              <p>⏱️ 7 days</p>
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="bg-white p-6 rounded-2xl shadow">
              ...
              <p className="text-gray-700">
                Lohri is one of Punjab’s most vibrant festivals, celebrated with bonfires, traditional songs,
                dances, and community gatherings. Experience authentic Punjabi culture, folk performances, food,
                and the warmth of Lohri festivities.
              </p>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-4 pb-10">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="h-72 bg-pink-200 rounded-2xl overflow-hidden">
            <img src={Holi2} alt="Lohri" className="w-full h-full object-cover" />
          </div>
          <div className="h-72 bg-gray-200 rounded-2xl overflow-hidden">
            <img src={Holi3} alt="Lohri Celebration" className="w-full h-full object-cover" />
          </div>
