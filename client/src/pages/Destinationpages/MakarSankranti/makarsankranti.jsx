...
export default function MakarSankranti() {
  ...
  const hotelNames = {
    "3-star": "Kiteview Lodge, Ahmedabad",
    "4-star": "Surya Comfort, Surat",
    "5-star": "Gujarat Grand Hotel, Ahmedabad",
  };

  // ☀️ MAKAR SANKRANTHI (3-day) Itinerary
  const [itinerary, setItinerary] = useState([
    {
      ...
      points: [
        ...
        "Evening: Local kite market visit and sunset photography.",
      ],
    },
    {
      day: "Day 2",
      cost: 6000,
      points: [
        "Full-day kite-flying festival at Sabarmati/Gujarat grounds.",
        "Traditional til & jaggery sweets tasting (til gul, chikki).",
      ],
    },
    {
      day: "Day 3",
      cost: 3500,
      points: [
        "Cultural walk: local temples & folk performances.",
  ...
  const highlights = [
    "Witness Uttarayan kite festival — thousands of kites in the sky",
    "Kite flying workshops & competitive kite battles",
    "Traditional sweets (til-gul), local street food tasting",
    "Cultural performances, photography walks & local bazaars",
  ];

  const included = [
    "Accommodation in selected hotel (2 nights)",
    "Breakfast daily & 1 festive meal",
    "Entry to kite festival zones and workshop",
    "Airport/train pickup & drop (within city limits)",
    "Local transport for scheduled activities",
  ];

  const notIncluded = [
    "Personal shopping & souvenirs",
    "Lunchs and dinners except the listed festive meal",
    "Premium private events or VIP passes",
  ...
  const getTotalCost = () => {
    ...
    // include a small festival surcharge per person
    const festivalFeePerPerson = 800;
  ...
  const handleDownload = async () => {
    ...
    addTitle("Makar Sankranti Kite Festival Tour");
    addText("📍 Ahmedabad & Surat, Gujarat");
    addText("📅 January 13 – January 15 (3 days)");
    addText("⭐ 4.7");
    ...
    addText("Duration: 3 days (Makar Sankranti)");
    ...
    pdf.save("MakarSankranti-Itinerary.pdf");
  };
    ...
    <div className="bg-gray-50 min-h-screen">
      <div ref={contentRef}>
        ...
        <div
          ...
          style={{ backgroundImage: `url(${Makar1})` }}
        >
          ...
          <div className="relative max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-3">
              {["Makar", "Kite", "Festival", "Uttarayan", "Gujarat"].map((tag) => (
                <span
                  key={tag}
            ...
            <h1 className="text-4xl font-bold drop-shadow-md">Makar Sankranti Kite Festival Tour</h1>

            <div className="flex flex-wrap items-center gap-4 mt-3 text-sm">
              <p className="flex items-center gap-1">
                <MapPin size={16} /> Ahmedabad & Surat
              </p>
              <p className="flex items-center gap-1">
                <CalendarDays size={16} /> Jan 13 – Jan 15
              </p>
              <p>⏱️ 3 days</p>
              <p className="flex items-center gap-1">
                <Star size={16} className="text-yellow-300" /> 4.7
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow">
              ...
              <p className="text-gray-700">
                Celebrate Makar Sankranti / Uttarayan in Gujarat — a spectacular kite festival
                with thousands of colorful kites dotting the sky. Join kite flying competitions,
                learn traditional kite-making, taste sesame and jaggery sweets, and enjoy lively
      ...
      <div className="max-w-6xl mx-auto px-4 pb-10">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="h-72 bg-pink-200 rounded-2xl overflow-hidden">
            <img src={Kite1} alt="Kite Festival" className="w-full h-full object-cover" />
          </div>
          <div className="h-72 bg-gray-200 rounded-2xl overflow-hidden">
            <img src={Kite2} alt="Kite Festival 2" className="w-full h-full object-cover" />
          </div>
