...
// ⭐ Update IMAGES here
import Pongal1 from "/Travel-Planner/client/src/assets/pongal.png";
import Pongal2 from "/Travel-Planner/client/src/assets/pongal.png";
import Pongal3 from "/Travel-Planner/client/src/assets/pongal.png";
...
export default function PongalFestival() {
  ...
  const basePrices = { "3-star": 11000, "4-star": 17000, "5-star": 24000 };
  const [baseBudget, setBaseBudget] = useState(basePrices[hotelType]);

  const hotelNames = {
    "3-star": "Golden Harvest Residency, Thanjavur",
    "4-star": "Coconut Valley Resort, Kumbakonam",
    "5-star": "Heritage Grand Palace, Thanjavur",
  };

  // 🔥 PONGAL (3-day) Itinerary
  const [itinerary, setItinerary] = useState([
    {
      day: "Day 1",
      cost: 3500,
      points: [
        "Arrival in Thanjavur & traditional welcome.",
        "Visit local markets decorated for Pongal.",
        "Evening cultural walk exploring Kolam (Rangoli) displays.",
      ],
    },
    {
      day: "Day 2",
      cost: 6500,
      points: [
        "Experience Thai Pongal celebrations with farmers.",
        "Witness cooking of ‘Pongal Pot’ ceremony.",
        "Visit heritage sites: Brihadeeswara Temple & cultural exhibitions.",
      ],
    },
    {
      day: "Day 3",
      cost: 4500,
      points: [
        "Jallikattu village visit (safe viewing zone).",
        "Witness Mattu Pongal – cattle decoration festival.",
        "Farewell traditional Tamil folk dance performance.",
      ],
    },
  ]);

  const highlights = [
    "Experience the Pongal pot boiling ceremony",
    "See colourful Kolam (rangoli) outside traditional homes",
    "Visit heritage-rich Thanjavur temples",
    "Witness Jallikattu from a safe, tourist-friendly area",
    "Traditional Tamil folk dances & cultural shows",
  ];

  const included = [
    "Accommodation in selected hotel (2 nights)",
    "Daily breakfast & one authentic Pongal feast",
    "Local transport for all festival activities",
    "Pongal village access pass",
    "Cultural performance entry tickets",
  ];

  const notIncluded = [
    "Personal shopping expenses",
    "Lunch & dinner except one included meal",
    "Jallikattu premium seating charges",
  ...
  const getTotalCost = () => {
    ...
    const festivalFeePerPerson = 600; // Pongal surcharge
  ...
  const handleDownload = async () => {
    ...
    addTitle("Pongal Festival Tour");
    addText("📍 Thanjavur, Tamil Nadu");
    addText("📅 January (3 days)");
    addText("⭐ 4.9");
    ...
    addText("Duration: 3 days (Pongal Festival)");
    ...
    <div className="bg-gray-50 min-h-screen">
      <div ref={contentRef}>
        ...
        <div
          ...
          style={{ backgroundImage: `url(${Pongal1})` }}
        >
          ...
          <div className="relative max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-3">
              {["Pongal", "Tamil Nadu", "Festival", "Culture"].map((tag) => (
                <span
                  key={tag}
            ...
            <div className="flex flex-wrap items-center gap-4 mt-3 text-sm">
              <p className="flex items-center gap-1">
                <MapPin size={16} /> Thanjavur, Tamil Nadu
              </p>
              <p className="flex items-center gap-1">
                <CalendarDays size={16} /> January
              </p>
              <p>⏱️ 3 days</p>
              <p className="flex items-center gap-1">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow">
              ...
              <p className="text-gray-700">
                Celebrate Tamil Nadu’s most important harvest festival –
                Pongal. Enjoy traditional rituals, the iconic Pongal pot
                ceremony, the stunning Kolam decorations, and experience village
                culture, folk performances, and the excitement of Jallikattu in
                a safe, guided setup.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow">
              ...
              <div className="mt-4">
                ...
                <select
                  ...
                  className="w-full border rounded-lg p-2 text-gray-700 focus:ring-2 focus:ring-green-500"
                >
              ...
              <div className="mt-4 bg-green-50 border border-green-200 rounded-lg p-3 text-sm text-gray-800">
                <p className="font-semibold text-green-700">🏨 Selected Hotel:</p>
              ...
              {isEditing ? (
                ...
                <button
                  ...
                  className="w-full mb-3 inline-flex items-center justify-center gap-2 bg-green-500/10 text-green-600 border border-green-600 py-2 rounded-xl font-semibold hover:bg-green-500/20 transition"
                >
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-green-500 to-yellow-400 text-white py-2 rounded-xl font-semibold hover:opacity-90 transition"
              >
                Download PDF
              </button>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-4 pb-10">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="h-72 bg-green-200 rounded-2xl overflow-hidden">
            <img
              src={Pongal2}
              alt="Pongal Celebrations"
