...
export default function CamelFestival() {
  ...
  const basePrices = { "3-star": 24000, "4-star": 36000, "5-star": 52000 };
  const [baseBudget, setBaseBudget] = useState(basePrices[hotelType]);

  const hotelNames = {
    "3-star": "Pushkar Heritage Inn",
    "4-star": "Desert View Resort, Pushkar",
    "5-star": "Royal Camel Grand, Pushkar",
  };

  // --- Camel Festival Itinerary (Pushkar-style Camel Fair) ---
  const [itinerary, setItinerary] = useState([
    {
      day: "Day 1–2",
      cost: 7000,
      points: [
        "Arrival in Pushkar / Ajmer and traditional Rajasthani welcome with folk music.",
        "Orientation walk through Pushkar market and temple area.",
        "Evening cultural program and local cuisine tasting.",
      ],
    },
    {
      day: "Day 3–5",
      cost: 15000,
      points: [
        "Witness the grand camel parade and livestock trading at the fairgrounds.",
        "Attend Kalbelia & Ghoomar dance performances and puppet shows.",
        "Sunset desert safari and camel ride experience.",
      ],
    },
    {
      day: "Day 6–8",
      cost: 12000,
      points: [
        "Visit Pushkar Lake, Brahma Temple & local artisan workshops.",
        "Participate in folk workshops (turban-tying, pottery demonstration).",
        "Farewell cultural night and group photos; depart next day.",
      ],
    },
  ]);

  const highlights = [
    "Grand camel parade & livestock trading",
    "Desert folk dances (Kalbelia & Ghoomar) and puppet shows",
    "Sunset camel ride & desert safari experience",
    "Pushkar Lake, temple visits & handicraft bazaars",
  ];

  const included = [
    "Accommodation in selected hotel",
    "Breakfast & dinner daily",
    "Entry to fairgrounds and local events",
    "Private AC vehicle for sightseeing (as per itinerary)",
    "Guided Pushkar town & artisan workshop visits",
  ];

  const notIncluded = [
    "Personal shopping & souvenirs",
    "Lunch on independent travel days",
    "Optional premium desert camp upgrades",
  ...
  const handleDownload = async () => {
    ...
    const addText = (text, size = 11) => {
      ...
      pdf.setFontSize(size);
      // wrap long text manually to avoid overflow
    ...
    addTitle("Camel Festival Tour (Pushkar Camel Fair)");
    addText("📍 Pushkar / Ajmer, Rajasthan, India");
    addText("📅 February 5 – February 12, 2025 (8 days)");
    addText("⭐ 4.8");
    ...
    pdf.save("Camel-Festival-Itinerary.pdf");
  };
        ...
        >
          ...
          <div className="relative max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-3">
              {["Camel Festival", "Pushkar", "Rajasthan", "Culture", "Camels"].map(tag => (
            ...
            <h1 className="text-4xl font-bold drop-shadow-md">Camel Festival Tour</h1>

            <div className="flex flex-wrap items-center gap-4 mt-3 text-sm">
              <p className="flex items-center gap-1"><MapPin size={16} /> Pushkar / Ajmer, Rajasthan</p>
              <p className="flex items-center gap-1"><CalendarDays size={16} /> February 5 – 12</p>
              <p>⏱️ 8 days</p>
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow">
              ...
              <p className="text-gray-700">
                The Pushkar Camel Festival is a vibrant desert event in Rajasthan featuring majestic camel parades,
                folk music and dance, traditional contests, bustling handicraft bazaars, and immersive cultural experiences.
              </p>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-4 pb-10">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="h-72 bg-pink-200 rounded-2xl overflow-hidden">
            <img src={Holi2} alt="Camel Festival" className="w-full h-full object-cover" />
          </div>
          <div className="h-72 bg-gray-200 rounded-2xl overflow-hidden">
            <img src={Holi3} alt="Camel Festival Celebration" className="w-full h-full object-cover" />
          </div>
