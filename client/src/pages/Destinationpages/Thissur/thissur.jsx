...
import Holi1 from "/Travel-Planner/client/src/assets/thissur.png";
import Holi2 from "/Travel-Planner/client/src/assets/thissur.png";
import Holi3 from "/Travel-Planner/client/src/assets/thissur.png";
...
export default function Thrissur() {
  ...
  const hotelNames = {
    "3-star": "Luciya Palace, Thrissur",
    "4-star": "Joy's Palace Hotel, Thrissur",
    "5-star": "The Garuda Hotel, Thrissur",
  };

  // ⭐ Thrissur Pooram Itinerary (updated)
  const [itinerary, setItinerary] = useState([
    {
      day: "Day 1–2",
      cost: 9000,
      points: [
        "Arrival in Thrissur & welcome ceremony.",
        "Visit Vadakkunnathan Temple.",
        "Explore Pooram market & festival preparations.",
      ],
    },
    {
      day: "Day 3–5",
      cost: 18000,
      points: [
        "Witness the Elanjithara Melam (Traditional percussion).",
        "Watch the majestic elephant parade at Thrissur Pooram.",
        "Evening fireworks viewing from special spots.",
      ],
    },
    {
      day: "Day 6–7",
      cost: 15000,
      points: [
        "Visit famous attractions: Athirapally Falls & Cheraman Juma Masjid.",
        "Cultural programs & Kerala traditional dinner.",
        "Farewell ceremony & group photos.",
      ],
    },
  ]);

  const highlights = [
    "Experience the grand elephant processions",
    "World-famous Thrissur Pooram fireworks show",
    "Traditional Kerala percussion performances",
    "Visit Vadakkunnathan Temple & cultural spots",
  ];

  const included = [
    "Accommodation in selected hotel",
    "Breakfast & dinner daily",
    "Entry to Pooram festival events",
  ...
  const notIncluded = [
    ...
    "Premium festival viewing gallery passes",
    "Travel insurance",
  ];
  ...
  const handleDownload = async () => {
    ...
    addTitle("Thrissur Pooram Festival Tour");
    addText("📍 Thrissur, Kerala");
    addText("📅 April 18 – April 25, 2025 (7 days)");
    addText("⭐ 4.8");
    ...
    pdf.save("Thrissur-Pooram-Itinerary.pdf");
  };
        ...
        >
          ...
          <div className="relative max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-3">
              {["Thrissur Pooram", "Kerala", "Festival", "Culture", "Elephants"].map(tag => (
            ...
            <h1 className="text-4xl font-bold drop-shadow-md">Thrissur Pooram Festival Tour</h1>

            <div className="flex flex-wrap items-center gap-4 mt-3 text-sm">
              <p className="flex items-center gap-1"><MapPin size={16} /> Thrissur, Kerala</p>
              <p className="flex items-center gap-1"><CalendarDays size={16} /> April 18 – 25</p>
              <p>⏱️ 7 days</p>
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow">
              ...
              <p className="text-gray-700">
                Thrissur Pooram — Kerala’s grandest temple festival — features magnificent elephant parades,
                traditional percussion, colourful umbrellas, and a spectacular fireworks show that lights up the night sky.
              </p>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-4 pb-10">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="h-72 bg-pink-200 rounded-2xl overflow-hidden">
            <img src={Holi2} alt="Pooram" className="w-full h-full object-cover" />
          </div>
          <div className="h-72 bg-gray-200 rounded-2xl overflow-hidden">
            <img src={Holi3} alt="Pooram" className="w-full h-full object-cover" />
          </div>
